...
export class Troop {
    constructor(scene, typeId, mergeLevel = 1, id) {
        ...
        Object.defineProperty(this, "mergeLevel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "tileX", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: -1
        });
        Object.defineProperty(this, "tileY", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: -1
    ...
    drawPolygon(g, sides, radius, color) {
        const points = [];
    ...
    setPosition(gridX, gridY, pixelX, pixelY) {
        this.tileX = gridX;
        this.tileY = gridY;
